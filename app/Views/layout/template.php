...
<head>
    ...
    <style>
        ...
        .nav-tabs {
            ...
            --bs-nav-tabs-link-active-color: crimson;
        ...
        .pagination {
            ...
            --bs-pagination-bg: crimson;
            --bs-pagination-border-color: #c30025;
...
<body class="bg-dark text-white">
    ...
    <nav class="navbar sticky-top bg-gray <?php $this->renderSection('padding') ?>" id="0">
    ...
    <footer class="bg-gray p-3">
        ...
        <ul class="nav justify-content-between col-3 col-sm-1 mx-auto">
            ...
            <li>
                <a href="https://instagram.com/abiisaleh">
            ...
            <li>
                <a href="https://discord.com/abiisaleh">
