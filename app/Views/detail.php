                ...
                <div class="card">
                    ...
                    <div class="col-12">
                        ...
                        if (isset($result['videos']['results'][0]['key'])) {
                            echo '<iframe src="https://www.youtube.com/embed/' . $result['videos']['results'][0]['key'] . '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style="width: 100%; height: 35vh;" allowfullscreen></iframe>';
                        } else {
                            echo '';
                        }
                        ?>
